  ...
  <div class="app-container">
    ...
    <el-card class="box-card garmin-form">
      <el-form :inline="true" :model="searchField">
        ...
        <el-form-item>
          <el-select v-model="searchField.category_id" placeholder="文章分类">
            <el-option
    ...
    >
      ...
      <el-table-column label="所属分类">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.article_categories.name }}</el-tag>
        </template>
      </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        self.$request({url:'/article/article', method:'GET', params}).then(response=>{
